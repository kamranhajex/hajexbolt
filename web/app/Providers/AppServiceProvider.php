...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $customDomain = env('SHOP_CUSTOM_DOMAIN', "date-niger-legislature-doctrine.trycloudflare.com");
        Context::initialize(
            env('SHOPIFY_API_KEY', 'd6cd33d6ba8a62d5ff6d548d45f0df32'),
            env('SHOPIFY_API_SECRET', 'b8ef05753bf0164f187cf1f1354ea397'),
